...
const FriendDetails = () => {
    ...
    return (
        ...
        <div className='min-h-[55vh] bg-green-800/15 py-8 md:py-20'>

            <div className='w-10/12 lg:w-250 xl:w-300 mx-auto flex flex-col md:flex-row justify-center items-center lg:justify-start lg:items-start gap-6'>
                
                <div className=''>
                    <div className="card bg-base-100 w-auto sm:w-96 md:w-70 lg:w-100 shadow-sm">
                        <figure className="px-10 pt-10">
                            <img src={picture} alt="Shoes" className="rounded-full w-32" />
                        </figure>
                        <div className="card-body items-center text-center">
                            <h2 className="card-title">{name}</h2>
                            <button className={`font-medium text-white text-sm px-3 py-1.5 rounded-full capitalize ${status == 'almost due' ? 'bg-amber-400' : status === 'overdue' ? 'bg-orange-600' : status === 'on-track' ? 'bg-green-800' : ''}`}>{status}</button>
                    ...
                    <div className=' w-auto sm:w-96 md:w-70 lg:w-100 mt-4 space-y-2 text-center font-medium content-center'>
                        ...
                        <div className='btn w-full bg-white p-6 text-red-600 font-bold'>
                ...
                <div className='flex-1  space-y-6'>
                    ...
                    <div className='flex gap-6 text-center'>
                        ...
                        <div className='bg-white w-full shadow-sm py-8 space-y-2'>
                            <h3 className='text-xl md:text-xl font-semibold md:font-extrabold text-green-800'>{formatted_next_due_date}</h3>
